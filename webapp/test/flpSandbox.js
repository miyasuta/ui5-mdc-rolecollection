		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#miyasutaui5mdcrolecollection-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"miyasutaui5mdcrolecollection-display": {
								"semanticObject": "miyasutaui5mdcrolecollection",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=miyasuta.ui5mdcrolecollection",
									"url": sap.ui.require.toUrl("miyasuta/ui5mdcrolecollection")
								}
							}
						}
					}
